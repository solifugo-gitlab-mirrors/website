...
ARG HUGO_SHA=025c36034048f3311e49f9be9f64b03a93b22fb77957736f9d28ff7365eef84b
ARG HUGO_EXTENDED_SHA=b060bd1ee3ddf66cf058cef50a94110f7b7165c2a3bd5b95b2dd66d8e98d7517
RUN set -eux && \
    case ${HUGO} in \
      *_extended) \
