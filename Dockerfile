...
ARG HUGO_SHA=3d720188e575fb3afffefe33df769dc1832d3a843c02119a01e30febd15c9dae
ARG HUGO_EXTENDED_SHA=793555365e06dd9809f7cbfaaa9fadd37214b9df3e4025c2cd16ecbd202a82ab
RUN set -eux && \
    case ${HUGO} in \
      *_extended) \
